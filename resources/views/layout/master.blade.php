...
<html lang="en">
  <head>
    ...
    <title>Zean's Sport Center</title>
    ...
    <link rel="stylesheet" href="{{asset('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap')}}">
          ...
          <div class="content-header bg-white-5">
            ...
            <a class="fw-semibold text-white tracking-wide" href="index.html">
              <span class="smini-hidden">
                Zean's<span class="opacity-75">Sport</span>
              </span>
            </a>
            <!-- END Logo -->
          ...
          <div class="content-side">
            <ul class="nav-main">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="/sewa">
                      <span class="nav-main-link-name">Tabel Sewa</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="/lapangan">
                      <span class="nav-main-link-name">Tabel Lapangan</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="/jadwal">
                      <span class="nav-main-link-name">Tabel Tarif</span>
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="/indexcetak">
                      <span class="nav-main-link-name">Cetak Laporan</span>
                    </a>
                  </li>
                </ul>
              </li>
          ...
          <div class="space-x-1">
            ...
            <div class="dropdown d-inline-block">
              ...
              <button type="button" class="btn btn-alt-secondary" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <span class="d-none d-sm-inline-block">Silahkan Login</span>
              ...
              <div class="dropdown-menu dropdown-menu-end p-0" aria-labelledby="page-header-user-dropdown">
                ...
                <div class="p-2">
                  ...
                  <a class="dropdown-item" href="/register">
                    <i class="far fa-fw fa-arrow-alt-circle-left me-1"></i> Register
                  </a>
                  <div role="separator" class="dropdown-divider"></div>
                  <a class="dropdown-item" href="/login">
                    <i class="far fa-fw fa-arrow-alt-circle-right me-1"></i> Login
                  </a>
                </div>
              </div>
              @else
                  ...
                  <div class="content py-0">
                    <div class="row fs-sm">
                      <div class="col-sm-6 order-sm-2 mb-1 mb-sm-0 text-center text-sm-end">
                        Crafted with <i class="fa fa-heart text-danger"></i> by <a class="fw-semibold" href="{{asset('https://1.envato.market/ydb')}}" target="_blank">Iswahyuddin Suhrillah</a>
                      </div>
                      <div class="col-sm-6 order-sm-1 text-center text-sm-start">
                        <a class="fw-semibold" href="{{asset('https://1.envato.market/r6y')}}" target="_blank">Dashmix 5.1</a> &copy; <span data-toggle="year-copy"></span>
                      </div>
                    </div>
                  </div>
                </footer> --}}
